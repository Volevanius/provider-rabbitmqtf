...
PROJECT_NAME ?= provider-rabbitmqtf
PROJECT_REPO ?= github.com/Volevanius/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-rabbitmq_v1.10.1
...
xpkg.build.provider-rabbitmqtf: do.build.images
