...
type InfoInitParameters struct {
	...
	// +mapType=granular
	DestinationApplicationProperties map[string]*string `json:"destinationApplicationProperties,omitempty" tf:"destination_application_properties,omitempty"`
	...
	// +mapType=granular
	DestinationProperties map[string]*string `json:"destinationProperties,omitempty" tf:"destination_properties,omitempty"`
	...
	// +mapType=granular
	DestinationPublishProperties map[string]*string `json:"destinationPublishProperties,omitempty" tf:"destination_publish_properties,omitempty"`
	...
	// +mapType=granular
	DestinationQueueArguments map[string]*string `json:"destinationQueueArguments,omitempty" tf:"destination_queue_arguments,omitempty"`
